...
- Post-dogfood readiness report: compact JSON from `agentmesh-public-0x-readiness-report` with `valid: true`, explicit pass reasons for coverage/freshness/adapter consistency, and normalized request artifact summaries.
